...
import { TrackEntity } from 'src/entitys/track.entity';
@Injectable()
export class FavsService {
  //constructor(
   // @InjectRepository(FavsEntity)
    // private FavsRepository: Repository<FavsEntity>, // @InjectRepository(TrackEntity) // private TrackRepository: Repository<TrackEntity>,
  //) {}
  async gelAll() {
